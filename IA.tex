...
% Tikz Graphs
\newcommand{\ruleSubintervals}{3}
\newcommand{\exampleSubintervals}{6}
...
The issue with increasing the number of subintervals is that the the methods consume significantly more processing power to execute.

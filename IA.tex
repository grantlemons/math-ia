...
An easy-to-implement method calculates the values of both the trapezoid and composite Simpson's 1/3 rules, compares the two, and---should they significantly differ---splits the subinterval in two and repeats the process.%~\ref{https://www.math.usm.edu/lambers/mat460/fall09/lecture30.pdf}

...
\newcommand{\normalEq}[1]{(13/sqrt(2*pi))*e^((-1/2)*x^2)}
...
\newcommand{\graphNormal}{\draw[darkgray, smooth, thick, samples=1500, domain={\leftbound-.05}:{\rightbound+.05}] plot(\x, {\normalEq{\x}}) node[darkgray, align=left, right, yshift=.15cm, xshift=-3.6cm] {\tiny\(f(x)\)};}
...
\subfile{graphs/adaptive/smps_complex_adpt}

...
\newcommand{\graphSimple}{\draw[darkgray, smooth, thick, samples=100, domain={\leftbound-.05}:{\rightbound+.05}] plot(\x, {((\x+(2/3))^3 + 2*(\x)^2)/3}) node[darkgray, align=left, right, yshift=-0.2cm, xshift=-2.9cm] {\tiny\(f(x)\)};}

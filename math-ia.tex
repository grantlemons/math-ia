...
% that would require very small step sizes
...
The primary only difference between the two is that the established method calls the Trapezoid Rule~(see \cref{lst:rust_rules}), while my method calls the difficulty function~(see \cref{lst:rust_helpers}).

...
\begin{listing}[ht]
\centering
\snippet{Functions in the program used for calculating the difficulty over a subinterval and the error percentage between two values that are used by other functions. Written in Rust}
